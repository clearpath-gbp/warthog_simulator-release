## warthog_simulator (noetic) - 0.2.2-1

The packages in the `warthog_simulator` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic warthog_simulator` on `Mon, 31 Jan 2022 14:06:47 -0000`
...
## warthog_simulator (melodic) - 0.2.2-2

The packages in the `warthog_simulator` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic warthog_simulator` on `Wed, 19 Jan 2022 01:30:18 -0000`
...
## warthog_simlator (melodic) - 0.2.2-1
